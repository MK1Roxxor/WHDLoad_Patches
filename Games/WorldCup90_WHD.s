...
; 05-Jul-2023	- patch uses files instead of disk image now
...
slv_CurrentDir	IFD	DEBUG
		dc.b	"SOURCES:WHD_Slaves/Games/WorldCup90/"
		ENDIF
		dc.b	"data",0
...
slv_info	dc.b	"installed by StingRay/[S]carab^Scoopex",10
		...
		dc.b	"Debug!!! "
		ENDC
		dc.b	"Version 2.00 (05.07.2023)",0
slv_config	dc.b	0
		CNOP	0,4
...
PT_GAME	dc.w	$afa4			; checksum
	dc.l	$d5dc,$d6a0		; start, end for CRC16
