	...
	; Chambers Of Shaolin imager

	; A track contains 6 sectors. Sector 0 to 4 contain 1024 bytes data,
	; sector 5 contains only 512 bytes. (Total: $1600 bytes)
	...
	; 2 unused bytes
	; 1 byte sector number (0-5) + $F5
	; 1 byte
	; 1 word checksum
	; gap
	; sync ($4489)
	; 1 byte data block ID (MFM: $5545)
	; 1024 or 512 bytes data
	; 1 word checksum
	...
	; Similar formats: Thalion games (uses the same CRC16 method)
		...
		dc.b	"$VER: "
Text:		dc.b	"Chambers Of Shaolin imager V1.0",10,"by Mr.Larmer/Wanted Team on 06.12.1999",0
		cnop	0,4
...
TL_1:
		...
		TLENTRY 2,158,$1600,SYNC_STD,DMFM_SGOJ
		TLENTRY	1,1,$1600,SYNC_STD,DMFM_SGOJ_long
		TLENTRY	3,159,$1600,SYNC_STD,DMFM_SGOJ
