...
*     -========================/===========|______\================-      *
*                                                                         *
*   .---.----(*(  THE CARDINAL OF THE KREMLIN WHDLOAD SLAVE )*)---.---.   *
*   `-./                                                           \.-'   *
*                                                                         *
*                         (c)oded by StingRay                             *
*                         --------------------                            *
...
; 14-Jan-2022	- support for another version added (Mantis #5469)
;		- year in last history was 2019 instead of 2018, fixed :)

; 08-Sep-2018	- intro skip option (CUSTOM1) added

; 07-Sep-2018	- work started
...
slv_CurrentDir	IFD	DEBUG
		dc.b	"SOURCES:WHD_Slaves/CardinalOfTheKremlin/"
		ENDC
		dc.b	"data",0

slv_name	dc.b	"The Kardinal of the Kremlin",0
slv_copy	dc.b	"1991 Capstone",0
slv_info	dc.b	"installed by StingRay/[S]carab^Scoopex",10
		IFD	DEBUG
		dc.b	"DEBUG!!! "
		ENDC
		dc.b	"Version 1.01 (14.01.2022)",0
...
PT_GAME	dc.l	$20d44,$20e5f,$60e0,PLGAME-PT_GAME
	dc.l	$20cec,$20e07,$60e0,PLGAME2-PT_GAME
	dc.l	-1					; end of tab
...
PLGAME	PL_START
	...
	PL_R	$759e		; disable manual protection
	PL_END

	; version sent by Christoph Gleisberg
PLGAME2	PL_START
	PL_R	$7542		; disable manual protection
	PL_END
