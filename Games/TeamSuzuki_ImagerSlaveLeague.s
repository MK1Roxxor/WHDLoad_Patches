...
*     -========================/===========|______\================-      *
*                                                                         *
*   .---.----(*(    TEAM SUZUKI LEAGUE DISK MAGER SLAVE     )*)---.---.   *
*   `-./                                                           \.-'   *
*                                                                         *
*                         (c)oded by StingRay                             *
*                         --------------------                            *
...
; 09-Apr-2021	- directory saving removed as the adapted patch
...
; 07-Apr-2020	- work started, adapted from the game imager
	...
	dc.b	"$VER: "
.text	dc.b	"Team Suzuki League Disk imager V1.1",10
...
.tracks	TLENTRY 002,002,$1800,SYNC_STD,DecodeTrack
	TLENTRY 003,003,$1800,SYNC_STD,DMFM_NULL
	TLENTRY 004,004,$1800,SYNC_STD,DecodeTrack
	TLEND
...
.find_end
	...
	IFD	SAVE_DIRECTORY
.DirectoryName	dc.b	"League.dir",0
	ENDC
