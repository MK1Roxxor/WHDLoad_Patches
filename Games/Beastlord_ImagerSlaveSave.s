...
*     -========================/===========|______\================-      *
*                                                                         *
*   .---.----(*(     BEASTLORD SAVE DISK IMAGER SLAVE       )*)---.---.   *
*   `-./                                                           \.-'   *
*                                                                         *
*                         (c)oded by StingRay                             *
*                         --------------------                            *
...
; 02-Jan-2012	- quickly changed to save "disk.3" file to keep
;		  install script simple

; 13-Dec-2011	- quickly adapted from the normal imager
	...
	dc.b	"$VER: "
.text	dc.b	"Beastlord save disk imager V1.0",10
...
.disk1	dc.l	0		; Pointer to next disk structure
	...
	dc.l	.FILELIST	; List of files to be saved
...
.FILELIST
	FLENTRY	.name,0,FL_DISKLENGTH
	FLEND

.name	dc.b	"disk.3",0
	CNOP	0,4

.tracks	TLENTRY 000,140,$1858,$4489,.decode1
	TLEND
