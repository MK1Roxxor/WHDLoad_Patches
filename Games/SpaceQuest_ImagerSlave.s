...
; 21-Dec-2015	- work started, adapted from my generic Amiga DOS imager
	...
	dc.b	"$VER: "
.text	dc.b	"Space Quest imager V1.0",10
...
CheckName
	...
	lea	.TAB(pc),a4
	move.l	a4,a3
	moveq	#1,d0			; default: name is invalid
.loop	move.w	(a3)+,d1
	beq.b	.done
...
.TAB	dc.w	.exclude1-.TAB		; HLS protection file
	dc.w	0
