...
;		30.11.23 last update broke highscore/lap times compatibility
;			 (issue #6318) 
;			 real cause for not displayed "super" animation found,
;			 jsr $300 instruction was missing!
;
;  :Requires.	-
